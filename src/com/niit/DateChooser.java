...
public class DateChooser extends JPanel {
    ...
    public DateChooser() {
        this(new Date());
        showDate.setFont(new Font("幼圆",Font.TYPE1_FONT,20));
    }
    ...
    public String getDate() {
        return sdf.format(select.getTime()).trim();
    }
    ...
    private class JP2 extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            g.setFont(font);
            g.drawString("sunday monday tuesday wednesday thursday friday saturday", 5, 10);
